...
import MainContent from '@/components/parts/TagihanPage/MainContent';
import { getAllPerusahaan } from '@/actions/perusahaan';

export const revalidate = 0

async function TagihanPage() {
  ...
  return (
    <main className="w-full md:w-5/6 bg-[#FDFDFD] container mx-auto pl-16 pr-12 pt-12 min-h-screen">
      <h1 className="text-3xl font-bold leading-snug tracking-wide text-[#9F9F9F]">Tagihan</h1>
      <MainContent 
